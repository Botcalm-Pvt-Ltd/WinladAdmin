  ...
  const getDataBasedOnRoleAndType = () => {
    return [
      ...(roleValue === "user" && (typeValue === "level01" || typeValue === "level02") ? [
        ...
        { label: "Raffle Purchases/Join For Raffle", key: "Raffle Purchases/Join For Raffle" },
        { label: "News", key: "News" },
      ...
      ...(roleValue === "admin" && typeValue === "super-admin" && page === 2 ? [
        { label: "View Super Admin Settings", key: "View Super Admin Settings" },
        { label: "Edit Super Admin Settings", key: "Edit Super Admin Settings" },
  ...
  return (
    <div className="">
      ...
      <div className="flex items-center justify-center gap-2 my-4">
        <button className="p-1 4xl:text-4xl" onClick={() => setPage((prev) => --prev)} ><ArrowBackIosIcon className=""/></button>
        <button className="p-1 4xl:text-4xl" onClick={() => setPage(1)}>1</button>
        {
