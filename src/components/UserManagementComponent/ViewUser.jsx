          ...
          <form onSubmit={handleSubmit} className="relative bottom-16">
            ...
            <div>
              <div className="flex gap-10">
                <ModelInputField label={"User Id"} readOnly={true} value={user.id}/>
                <ModelInputField label={"User Name"} readOnly={true} value={user.name}/>
              </div>
              <div className="flex gap-10">
              ...
              <div className="flex gap-10">
                <ModelInputField label={"NIC"} readOnly={true} value={user.NIC}/>
                <ModelInputField label={"User Email"} readOnly={true} value={user.MNumber}/>
              </div>
              <div>
