...
const Role = () => {
  return (
    <div className="absolute top-0 right-0 rounded-bl-3xl rounded-br-3xl  bg-black w-1/2 lg:w-6/12 h-2/6 lg:h-1/2">
      <div className="flex flex-row gap-10 px-5 mt-20">
        <select
          name="filter"
          className="bg-yellow-300 px-3 py-2 rounded-lg   xl:w-1/2  w-1/4  text-center  outline-none "
        >
