    ...
    return (
        <>
            ...
            {show && (
                ...
                <div className='fixed top-0 left-0 w-full h-full z-10 flex flex-col items-center justify-center bg-white bg-opacity-50'>
                    
                    <div className='rounded-xl py-8 shadow-2xl bg-white w-full md:w-3/4 lg:w-1/2 mx-auto text-center px-10 relative'>
                    <div className='absolute top-3 right-3 cursor-pointer' onClick={()=>setShow(false)}>
                    <IoMdClose/>
                    </div>
                    ...
                    <OutsideClickHandler onOutsideClick={()=>setShow(false)} >
                        ...
                        <div className='mt-8'>
                            <div className="input-area flex items-center text-black justify-between mb-3">
                                ...
                                <input type="text" name="name" className='bg-gray-200 outline-none border-none px-3 py-0.5 w-1/2 rounded-lg' />
                            </div>
                            <div className="input-area flex items-center text-black justify-between mb-3">
